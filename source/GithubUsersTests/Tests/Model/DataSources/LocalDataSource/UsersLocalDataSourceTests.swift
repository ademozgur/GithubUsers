...
extension UserDetails {
    static var example: UserDetails {
        UserDetails(id: 1, login: "adem", avatarUrl: "avatarUrl", name: "name", followers: 22, location: "Berlin")
    }

    static var example2: UserDetails {
        UserDetails(id: 2, login: "adem", avatarUrl: "avatarUrl", name: "name", followers: 22, location: "Berlin")
    }
}
